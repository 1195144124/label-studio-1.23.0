...
通过在项目中导入main.css 和main.js 来使用 label-Studio标注工具

```javascript
    <link rel="stylesheet" href="/labelStudio-1.23/main.css" />
    <script src="/labelStudio-1.23/main.js" type="module"></script>
```

```javascript
    "lsf:serve": "cross-env NODE_ENV=development FRONTEND_HOSTNAME=http://localhost:3000 MODE=standalone nx run editor:serve:development",
    "lsf:serve-static": "cross-env MODE=standalone nx run editor:serve-static",
```
